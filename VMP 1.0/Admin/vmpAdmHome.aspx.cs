            ...
            if (!IsPostBack)
            {
                if (Request.QueryString["Response"] != null)
                {
                    if (Request.QueryString["Response"] == "Reject")
                    {
                        ...
                        ScriptManager.RegisterStartupScript(this, this.GetType(), "CallMyFunction1", "showMessage()", true);
                    }
                ...
                qur = "[proc_getPortalDataForDashboard]";
                ...
                {
                    lblLastPortalApp.Text = ds1.Tables[1].Rows[0]["LastAppReceived"].ToString();
                }
                else
                {
                    divLastPortal.Attributes.Add("style", "margin-top:10px;display: none;");
                }
            }
        }
