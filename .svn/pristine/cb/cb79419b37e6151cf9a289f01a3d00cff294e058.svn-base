...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        function fnCheck() {
            ...
            else if((document.getElementById("<%=txtShortFormNew.ClientID%>").value).length == 0){
                document.getElementById('lblerr').style.display = 'block';
            }
            else if((document.getElementById("<%=txtOrderNew.ClientID%>").value).length == 0){
                document.getElementById('lblerr').style.display = 'block';
            }
            else {
                    ...
                    <div class="col-md-6">
                        <asp:GridView ID="grdClassification" runat="server" CssClass="table1" AutoGenerateColumns="false" OnRowDataBound="grdClassification_RowDataBound" OnSelectedIndexChanged="grdClassification_SelectedIndexChanged" DataKeyNames="ClassificationId" HeaderStyle-Font-Bold="true" HeaderStyle-BackColor="Gray" BackColor="White" HeaderStyle-ForeColor="White" Style="width: 100%;">
                            <Columns>
                                ...
                                <asp:BoundField DataField="shortForm" HeaderText="Short Form" HeaderStyle-HorizontalAlign="Center" />
                                <asp:BoundField DataField="orderBy" HeaderText="Order for Designation" HeaderStyle-HorizontalAlign="Center" />
                        ...
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="input-group" style="width: 100%; margin: 0 auto; padding-bottom: 10px; text-align: center; margin-left: -30px;">
                                    <asp:TextBox ID="txtClassification" runat="server" class="form-control"  Style="width: 90%; border-top-right-radius: 4px; border-bottom-right-radius: 4px;"></asp:TextBox>
                                </div>
                            </div>
                            <div class="row">
                                <label>Short Form</label>
                                <div class="input-group" style="width: 100%; margin: 0 auto; padding-bottom: 10px; text-align: center; margin-left: -30px;">
                                    <asp:TextBox ID="txtShortForm" runat="server" class="form-control" Style="width: 90%; border-top-right-radius: 4px; border-bottom-right-radius: 4px;"></asp:TextBox>
                                </div>
                            </div>
                            <div class="row">
                                <label>Order For Designation</label>
                                <div class="input-group" style="width: 100%; margin: 0 auto; padding-bottom: 10px; text-align: center; margin-left: -30px;">
                                    <asp:TextBox ID="txtOrder" runat="server" class="form-control" Style="width: 90%; border-top-right-radius: 4px; border-bottom-right-radius: 4px;"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <label>Classification Description</label>
                                <div class="input-group" style="width: 100%; margin: 0 auto; padding-bottom: 10px; text-align: center; margin-left: -30px;">
                                    <asp:TextBox ID="txtClassificationNew" runat="server" class="form-control" Style="width: 90%; border-top-right-radius: 4px; border-bottom-right-radius: 4px;"></asp:TextBox>
                            ...
                            <div class="row">
                                <label>Short Form</label>
                                <div class="input-group" style="width: 100%; margin: 0 auto; padding-bottom: 10px; text-align: center; margin-left: -30px;">
                                    <asp:TextBox ID="txtShortFormNew" runat="server" class="form-control" Style="width: 90%; border-top-right-radius: 4px; border-bottom-right-radius: 4px;"></asp:TextBox>
                                </div>
                            </div>
                            <div class="row">
                                <label>Order For Designation</label>
                                <div class="input-group" style="width: 100%; margin: 0 auto; padding-bottom: 10px; text-align: center; margin-left: -30px;">
                                    <asp:TextBox ID="txtOrderNew" runat="server" class="form-control" Style="width: 90%; border-top-right-radius: 4px; border-bottom-right-radius: 4px;"></asp:TextBox>
                                </div>
                            </div>
                            <div class="row">
